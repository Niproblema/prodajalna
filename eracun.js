...
streznik.get('/', function(zahteva, odgovor) {
  if(zahteva.session.seznamStrank == null || zahteva.session.seznamStrank == undefined){
...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function(napaka1, polja, datoteke) {
    ...
    strankaIzRacuna(racunId, function(podatkiS) {
      if (podatkiS != null && podatkiS.length != 0) {
        pesmiIzRacuna(racunId, function(podatkiP) {
          if (podatkiP != null && podatkiP.length != 0) {
            
            odgovor.setHeader('content-type', 'text/xml');
            odgovor.render('eslog', {
              vizualiziraj: true,
              postavkeRacuna: podatkiP,
              stranka: podatkiS[0]
            })
          }
        });
